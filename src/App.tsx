...
function Protected({ children }: { children: JSX.Element }) {
  ...
  return <ConnectionGuard><><PresencaAutomatica userId={user.id} /><GlobalDataSync userId={user.id} /><GlobalAchievementPopup userId={user.id} /><BattleSupportHydrator userId={user.id} /><BattleSupportCreateHydrator userId={user.id} />{children}</></ConnectionGuard>;
}
