...
import MeuCantinho from "@/pages/MeuCantinho";
...
function Protected({ children }: { children: JSX.Element }) {
  ...
  return <ConnectionGuard><><PresencaAutomatica userId={user.id} />{children}</></ConnectionGuard>;
}
        ...
        <LowPowerProvider>
          <BrowserRouter>
            ...
            <Routes>
              ...
              <Route path="/meu-cantinho" element={<Protected><MeuCantinho /></Protected>} />
              ...
              <Route path="/diario" element={<Protected><Imersao /></Protected>} />
